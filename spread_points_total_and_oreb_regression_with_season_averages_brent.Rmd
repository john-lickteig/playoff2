...
```{r}
games_final_for_OREB <- subset(games_final, select = -c(Spread,Total,PTS_home,PTS_away))
full.model.OREB <- lm(OREB ~., data = games_final_for_OREB)
step.model.OREB <- stepAIC(full.model.OREB, direction = "both", trace = FALSE)
summary(step.model.OREB)
```
