...
```{r}
season_level_only_final <- season_level_only_1[, c("GAME_DATE_EST.y", "Home.Team", "Away.Team", "Spread", "Total", "OREB", "PTS_home_avg", "PTS_away_avg", "OREB_home_avg", "OREB_away_avg", "DREB_home_avg", "DREB_away_avg", "FGM_home_avg", "FGM_away_avg", "FGA_home_avg", "FGA_away_avg", "FG3M_home_avg", "FG3M_away_avg", "FG3A_home_avg", "FG3A_away_avg", "FTM_home_avg", "FTM_away_avg", "FTA_home_avg", "FTA_away_avg", "AST_home_avg", "AST_away_avg", "STL_home_avg", "STL_away_avg", "BLK_home_avg", "BLK_away_avg", "TO_home_avg", "TO_away_avg", "PF_home_avg", "PF_away_avg", "PM_home_avg", "PM_away_avg")]

season_level_stats <- season_level_only_final %>%
  rename("GAME_DATE_EST"= GAME_DATE_EST.y)
