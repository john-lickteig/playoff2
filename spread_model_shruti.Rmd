...
lm(formula = (PTS_home) ~ FGM_home + FTM_home + FG3M_home + OREB + 
    FG3A_home, data = final_game_data_with_rolling_avg)
...
Call:
lm(formula = (PTS_away) ~ FGM_away + FTM_away + FG3M_away + LAST_5_AVG_PTS_away + 
    BLK_away + HOME_TEAM_WINS, data = final_game_data_with_rolling_avg)
