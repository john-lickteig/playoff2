...
```{r}
stepwise_oreb <- glm(formula = OREB ~ FTA_home_against_avg + TO_away_avg, family = "poisson", data = train_data)
...
neuralnet_oreb <- neuralnet(OREB ~.-Spread -Total -OREB_home_avg -OREB_away_avg - OREB_home_against_avg - OREB_away_against_avg, data=train_data, hidden=10, act.fct = "logistic", linear.output = FALSE)
...
regtree_oreb <- rpart(OREB ~.-Spread -Total -OREB_home_avg -OREB_away_avg - OREB_home_against_avg - OREB_away_against_avg, data=train_data, method  = "anova")
